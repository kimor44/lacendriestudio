	...
	$.fn.fbuilder = function(options){
		...
		{
			$("#tabs-1").append('<div style="clear:both;"></div><div>'+$.fbuilder.htmlEncode(categoryList[ i ].title)+'</div><hr />');
    ...
    $.fbuilder[ 'showSettings' ] = {
		...
		showName: function( v ) 
		{
			return '<div><label>Field name, tag for the message:</label><input readonly="readonly" class="large" name="sNametag" id="sNametag" value="&lt;%'+v+'%&gt;" />'+
				   '<input style="display:none" readonly="readonly" class="large" name="sName" id="sName" value="'+$.fbuilder.htmlEncode(v)+'" /></div>';
		},
		...
		{
			return '<div><label>Equal to [<a class="helpfbuilder" text="Use this field to create password confirmation field or email confirmation fields.\n\nSpecify this setting ONLY into the confirmation field, not in the original field.">help?</a>]</label><br /><select class="equalTo" name="sEqualTo" id="sEqualTo" dvalue="'+$.fbuilder.htmlEncode(v)+'" dname="'+name+'"></select></div>';
		},
