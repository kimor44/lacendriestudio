    ...
    class CP_WPTimeSlotsBK_Elementor {
      ...
      function enqueue_frontend_styles() {
          ...
          wp_enqueue_script( $this->prefix.'_builder_script',
                 get_site_url( get_current_blog_id() ).'?cp_cptslotsb_resources=public&nc=1',array("jquery","jquery-ui-core","jquery-ui-datepicker","jquery-ui-widget","jquery-ui-position","jquery-ui-tooltip"), false, true );          
      }      
