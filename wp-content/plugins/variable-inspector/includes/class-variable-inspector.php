...
class Variable_Inspector
{
    ...
    private function load_dependencies()
    {
        ...
        /**
         * Include vendor libraries, e.g. kint
         * 
    ...
    public function is_vi()
    {
        ...
        if ( strpos( $request_uri, $this->plugin_name ) !== false ) {
            return true;
            // Yes, this is the plugin's main page
        } else {
            return false;
            // No, this is not the plugin's main page
        }
    ...
    private function define_admin_hooks()
    {
        ...
        if ( is_admin() && $this->is_vi() ) {
            ...
            // Update footer and version text
        ...
        $this->loader->add_action( 'wp_ajax_vi_generate_sample_results', $plugin_admin, 'vi_generate_sample_results' );
        $this->loader->add_action(
            'admin_notices',
            $plugin_admin,
            'vi_suppress_admin_notices',
            0
        );
        // Load early with priority 5 (default is 10)
        $this->loader->add_action(
            'all_admin_notices',
            $plugin_admin,
            'vi_suppress_all_admin_notices',
            0
        );
        // Load early with priority 5 (default is 10)
    }
