...
?>
<input type="hidden" class="wbk_services" data-attribute_name="service-id" id="wbk-service-id" data-multi-low-limit="<?php echo esc_attr( $service->get_multi_mode_low_limit() ); ?>" data-multi-limit="<?php echo $service->get_multi_mode_limit(); ?>" value="<?php echo intval( $service_id ); ?>" />
