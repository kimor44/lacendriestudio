...
if ( $end > $start ) {
    while ( $start <= $end ) {
        ...
        foreach ( $bookings_on_date as $booking_id ) {
            ...
            $price = $booking->get_price() * $booking->get_quantity();
    ...
    <li>
        <div class="data-icon-wrapper-wb">
            <span class="data-icon-wb">
                <img src="<?php 
echo  WP_WEBBA_BOOKING__PLUGIN_URL ;
?>/public/images/data-approved-bookings-icon.png" alt="money">
            </span><!-- /.data-icon-wb -->
        </div><!-- /.data-icon-wrapper-wb -->
        <div class="data-content-wb">
            <div class="digit-wb"><?php 
    ...
    <li>
        <div class="data-icon-wrapper-wb">
            <span class="data-icon-wb">
                <img src="<?php 
echo  WP_WEBBA_BOOKING__PLUGIN_URL ;
?>/public/images/data-pending-bookings-icon.png" alt="money">
            </span><!-- /.data-icon-wb -->
        </div><!-- /.data-icon-wrapper-wb -->
        <div class="data-content-wb">
            <div class="digit-wb"><?php 
