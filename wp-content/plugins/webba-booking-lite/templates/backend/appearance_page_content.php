            ...
            <div class="appearance-block-wb">
                <div class="left-part-wb">
                        ...
                        <div class="single-tab-wb active-wb" data-js="single-tab-wb" data-name="borders">
                            <div class="field-block-wb">
                                ...
                                <div class="field-wrapper-wb" data-js-block="color-picker-wrapper-wb">
                                    <input type="color" value="<?php echo esc_attr( $field_value_1 );?>" class="color-picker-wb input-wb" data-class="appointment-status-wrapper-w,circle-chart-wb" data-property="background-color,border-color">
                                    <input type="text"  class="input-text-color-wb input-text-wb input-wb" value="<?php echo esc_attr( $field_value_1 );?>"  data-class="appointment-status-wrapper-w,circle-chart-wb" id="wbk_appearance_field_1" data-property="background-color,border-color" >
                            ...
                            <div class="field-block-wb">
                                ...
                                <div class="field-wrapper-wb" data-js-block="color-picker-wrapper-wb">
                                    <input type="color" value="<?php echo esc_attr( $field_value_2 );?>"  class="color-picker-wb input-wb" data-class="button-w,wb_slot_checked,middleDay,checkmark-w,checkbox-subtitle-w,wbk_service_item_active" data-property="background-color,border-color">
                                    <input type="text"  class="input-text-color-wb input-text-wb input-wb" value="<?php echo esc_attr( $field_value_2 );?>"  data-class="button-w,wb_slot_checked,middleDay,checkmark-w,checkbox-subtitle-w,wbk_service_item_active" id="wbk_appearance_field_2" data-property="background-color,border-color" >
                                </div> 
                            </div>          
                        </div> 
                    </div> 
                    ...
                    <div class="buttons-block-wb">
                        <button  type="submit"  class="button-wb button-wb-appearance-save"><?php echo __( 'Save', 'webba-booking-lite' ) ?><span class="btn-ring-wb"></span></button>
                    </div>
                </div><!-- /.left-part-wb -->
