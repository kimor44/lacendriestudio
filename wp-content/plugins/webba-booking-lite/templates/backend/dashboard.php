        ...
        <div class="custom-table-wrapper-wb <?php echo $table_name; ?>-custom-table-wb" custom-table-wrapper>
            <div class="table-area-wb">
                <div class="block-heading-wb">
                    <h2 class="block-title-wb"><?php _e( 'Bookings made in the last 24 hours', 'webba-booking-lite' ); ?></h2>
                    <div class="right-part-wb">
                        <a href="#" class="past-bookings-link-wb"><?php _e( 'Show past bookings', 'webba-booking-lite' ); ?></a>
                        <button class="button-wb"><span class="text-wb"><?php _e( 'New booking', 'webba-booking-lite' ); ?></span> <span class="plus-icon-wb"></span></button>                    
                    </div>
                </div>
	...
	<div class="content-main-wb">
        <div class="dashboard-container">	
            <div class="dashboard-header-wb">
                <div class="left-part-wb">
                    <div class="block-title-wb">
                        <img src="<?php echo WP_WEBBA_BOOKING__PLUGIN_URL; ?>/public/images/hello-dashboard.png"/>
                        <span class="title-text-wb"><?php printf( esc_html__( 'Hello %s', 'webba-booking-lite' ), esc_html( $user->display_name ) ); ?></span>
                    </div>
            ...
            <div class="bookings-table-area-wb table-area-wb wbk_hidden" data-empty-table>
                <div class="block-heading-wb">
                    <h2 class="block-title-wb"><?php _e( 'Bookings', 'webba-booking-lite' ); ?></h2>         
                </div><!-- /.block-heading-wb -->
                <div class="table-empty-content-wb">
                    <div class="empty-image-wb">
                        <img src="<?php echo WP_WEBBA_BOOKING__PLUGIN_URL; ?>/public/images/bookings-empty.png" alt="bookings empty">
                    </div><!-- /.empty-image-wb -->
                    <div class="text-wb"><?php _e( "You don't have any bookings for this time period yet", 'webba-booking-lite' ); ?></div>
                </div>
            ...
            <div class="dashboard-header-wb dashboard-data-range-part-wb">
                <div class="field-container-wb">
                    ...
                    <div class="date-range-select-container">
                        ...
                        <div class="custom-select-wb">
                                <input name="appointment_day" data-formated-date=<?php echo esc_attr( $formatted_last_30_days ); ?> value="<?php echo esc_attr( $formatted_last_30_days ); ?>" data-dateformat="<?php echo esc_attr( $date_format_js ); ?>" class="plugion_input_date_range_start plugion_input_text plugion_filter_daterange plugion_filter_input" placeholder="Start date">
                        </div>
                        
                        <div class="custom-select-wb">
                                <input name="appointment_day" data-formated-date=<?php echo esc_attr( $formatted_last_30_days ); ?> value="<?php echo esc_attr( $formatted_yesterday ); ?>" data-dateformat="<?php echo esc_attr( $date_format_js ); ?>" class="plugion_input_date_range_end plugion_input_text plugion_filter_daterange plugion_filter_input" placeholder="End date">
                        </div>
                ...
                <div class="field-container-wb">
                    <div class="custom-select-wb" data-date-filter>
                        <select>
                            <option value="today"><?php _e( 'Today' ,'webba-booking-lite' ); ?></option>
                            <option value="l_7"><?php _e( 'Last 7 days' ,'webba-booking-lite' ); ?></option>
                            <option value="u_7"><?php _e( 'Upcoming 7 days' ,'webba-booking-lite' ); ?></option>
                            <option value="l_30" selected><?php _e( 'Last 30 days' ,'webba-booking-lite' ); ?></option>
                            <option value="u_30"><?php _e( 'Upcoming 30 days' ,'webba-booking-lite' ); ?></option>
                            <option value="custom"><?php _e( 'Custom' ,'webba-booking-lite' ); ?></option>
                        </select>
                ...
                <div class="block-header-wb">
                    <div class="title-wb">
                        ...
                        <div class="help-popover-wb" data-js="help-popover-wb">
                            ...
                            <div class="help-popover-box-wb" data-js="help-popover-box-wb"><?php esc_html__( 'Interests/Conversions', 'webba-booking-lite' );  ?></div>
                        </div><!-- /.help-popover-wb -->
                    </div><!-- /.title-wb -->
                    <div class="right-part-wb">
                        <ul class="toggle-switch-wb" toggle-switch>
                            <li class="active-wb"><?php esc_html__( 'Week', 'webba-booking-lite' );  ?></li>
                            <li><?php esc_html__( 'Week', 'webba-booking-lite' );  ?></li>
                        </ul><!-- /.toggle-switch-wb -->
                    </div><!-- /.right-part-wb -->
                </div><!-- /.block-header-wb -->
                
                <div class="graph-wb">
                    <canvas id="dashboard-graph" class="wbk_hidden" data-price-format="<?php echo esc_attr( $price_format ); ?>"></canvas>
                    <div class="table-empty-content-wb wbk_hidden">
                            <div class="empty-image-wb">
                                <img src="<?php echo WP_WEBBA_BOOKING__PLUGIN_URL; ?>/public/images/interests-empty.png" alt="interests empty">
                            </div><!-- /.empty-image-wb -->
                            <div class="text-wb"><?php _e( 'Booking statistics graph is available for Webba Booking Pro users only', 'webba-booking-lite' ); ?></div>
                        </div>            
                </div><!-- /.graph-wb -->
