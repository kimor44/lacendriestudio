...
<div class="field-block-wb editor-block-wb" <?php echo $dependency; ?>>
    <div class="field-block-wb with-toggle-editor-wb">
        <div class="label-wb">
            <label for="message-to-customer-wb"><?php echo esc_html( $data['title'] ); ?></label>
        ...
        <button type="button" class="button-wb button-small-wb wbk_option_toggle_editor" ><?php _e( 'Toggle editor', 'webba-booking-lite' ) ?></button>
    </div>
