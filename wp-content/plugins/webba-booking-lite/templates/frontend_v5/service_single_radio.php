...
<label class="wbk-input-label wbk_service_label wbk_hidden"><?php echo WBK_Validator::kses(
    get_option('wbk_service_label', __('Select service', 'webba-booking-lite'))
); ?></label>
...
<?php foreach ($service_ids as $service_id) {
    ...
    <li class="wbk_service_item  timeslot-animation-w wbk_hidden" data-servicei_id="<?php echo esc_attr(
        ...
        <label class="custom-radiobutton-w">
            ...
            <input type="radio" data-payable="<?php echo esc_attr(
                $payable
            ); ?>" class="wbk-input wbk_hidden wbk_services wbk_service_radio" data-validation="positive"  name="service" value="<?php echo $service->get_id(); ?>">
