        ...
        <div class="appointment-content-w">            
            ...
            <form>
                ...
                <div class="button-block-w two-buttons-w">
                    <button type="button" class="button-w button-prev-w"><?php echo esc_html__( 'Back'  ) ?></button>
                    <button type="button" class="button-w button-next-w"><?php echo esc_html__( 'Next' ) ?><span class="btn-ring-wb"></span></button>
                </div><!-- /.button-block-w -->
