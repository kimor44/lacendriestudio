...
?>
        <div class="field-row-w ">
            ...
            <input type="text" data-validationmsg="<?php echo esc_attr( __( 'Please, enter customer name' ), 'webba-booking-lite' ) ?>" class="input-text-w wbk-input " data-validation="not_empty" name="custname" >
        </div>
        <div class="field-row-w">
        ...
        <div class="field-row-w">
            ...
            <input type="text" data-validationmsg="<?php echo esc_attr( __( 'Please, enter phone number' ), 'webba-booking-lite' ) ?>" class="input-text-w wbk-input" data-validation="phone" name="phone" >
        </div>
        <div class="field-row-w">
