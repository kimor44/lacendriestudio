...
<div class="payment-details-wrapper-w">
    <table cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                <td><?php echo esc_html( get_option( 'wbk_payment_details_title' , 'Payment details') );?></td>
                <td></td>
            </tr>
        </thead>
        <tbody>
            ...
            ?>
                    <tr>
                        ...
                        <td><?php echo WBK_Format_Utils::format_price( $payment_items['prices'][$i] ); ?> </td>
                    </tr>
            <?php
                $i++;
                }
                if( $payment_items['tax_to_pay' ]  > 0 ){
                    ?>
                    <tr>
                        <td><?php echo esc_html( get_option( 'wbk_tax_label', __( 'Tax', 'webba-booking-lite' ) )  ); ?></td>
                        <td><?php echo WBK_Format_Utils::format_price( $payment_items['tax_to_pay' ] ); ?> </td>
                    </tr>
                    <?php
                }               
            ?>
