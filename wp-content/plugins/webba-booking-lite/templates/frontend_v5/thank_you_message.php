...
<div class="thank-you-block-w">
    <div class="thank-you-content-w">
        <div class="image-wrapper-w">
                <img class="wb-thank-you-image" src="<?php echo WP_WEBBA_BOOKING__PLUGIN_URL . '/public/images/thank_you.gif' ?>" alt="thank you">
        </div><!-- /.image-wrapper-w -->
        ...
        <div class="thank-you-mobile-w">
            ...
            ?>
                <div class="thank-you-subtitle-mobile-w"><?php echo __('Booking confirmation<br>  has been sent to your email address.', 'webba-booking-lite'); ?></div>
            <?php    
                }                
            ?>
        </div> 
        <?php
            ...
            if( $payment_details['total'] > 0 ){
                ...
                <ul class="thank-you-list-w">
                    <li>
                        <span class="list-icon-w"><img src="<?php echo WP_WEBBA_BOOKING__PLUGIN_URL . '/public/images/dollar-icon.png' ?>" alt="$"></span>
