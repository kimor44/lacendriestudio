						...
						<div class="wbk-inner-container">
							<div class="wbk-frontend-row">
								<div class="wbk-col-12-12">
									<div class="wbk-input-label">
									 	<?php 
        echo  __( 'appointment(s) not found', 'wbk' ) ;
        ?>
									</div>
								</div>
							</div>
...
<div class="wbk-outer-container wbk_booking_form_container">
	<div class="wbk-inner-container">
 	<img src=<?php 
echo  WP_WEBBA_BOOKING__PLUGIN_URL . '/frontend/images/loading.svg' ;
...
?>
        ...
        <div class="wbk-frontend-row">
            <input type="button" disabled="disabled" class="wbk-button wbk-width-100 wbk-mt-10-mb-10" id="wbk-confirm-services" value="<?php 
echo  __( 'Start booking', 'wbk' ) ;
?>">
        </div>
