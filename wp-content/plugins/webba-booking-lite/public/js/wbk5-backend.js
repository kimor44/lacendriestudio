class Plugion_WBK {
    ...
    save_properties(table, row_id) {
        ...
        const propertyInfo = propertyContainerForm.find(
            '.plugion_propery_info'
        );
        ...
        jQuery.ajax(plugionl10n.rest_url + 'plugion/v1/save-properties', {
            ...
            statusCode: {
                ...
                422: function (response) {
                    ...
                    jQuery('[data-js="sidebar-roll-wb"]').removeClass(
                        'loading'
                    );
                },
            },
    ...
    get_field_value(elem) {
        ...
        if (typeof elem.attr('data-getter') !== 'undefined') {
            var value =
                get_this().field_getters[elem.attr('data-getter')](elem);
        } else {
            var value = elem.val();
        }
        return value;
    ...
    */
    ...
    properties_form_open(dataName) {
        ...
        if (containerAdd.length) {
            const sidebarRoll = containerAdd.find(
                '[data-js="sidebar-roll-wb"]'
            );
            sidebarRoll
                .find('.help-popover-box-wb')
                ...
                statusCode: {
                    200: function (response) {
                        ...
                        jQuery('#appointment_time').on('change', function () {
                            ...
                            jQuery('#appointment_quantity').niceSelect(
                                'update'
                            );
                        });
                        jQuery('#appointment_time').niceSelect('update');
