    ...
    public function initSettings()
    {
        ...
        wbk_opt()->add_option(
            ...
            [
                ...
                'popup' => __(
                    'Select your local timezone for both the backend and booking form.',
                    'webba-booking-lite'
                ),
            ]
        );
        ...
        wbk_opt()->add_option(
            ...
            [
                ...
                'extra' => [
                    ...
                    'narrow' => __(
                        'For themes with narrow columns',
                        'webba-booking-lite'
                    ),
                ],
                'popup' => __(
                    'Choose between the default layout or the layout optimized for themes with narrow columns.',
                    'webba-booking-lite'
                ),
            ]
        );
        ...
        wbk_opt()->add_option(
            ...
            [
                'popup' => __(
                    'Turn on to activate the multiple booking mode that allows booking multiple time slots in the same booking.',
                    'webba-booking-lite'
                ),
                'default' => '',
        ...
        wbk_opt()->add_option(
            ...
            [
                ...
                'extra' => [
                    ...
                    'enabled_mask_plugin' => __(
                        'jQuery Mask Plugin',
                        'webba-booking-lite'
                    ),
                    'disabled' => __('Disabled', 'webba-booking-lite'),
                ],
                'dependency' => ['wbk_mode' => 'extended|simple'],
            ]
        );
        wbk_opt()->add_option(
            'wbk_phone_format',
            ...
            [
                ...
                'popup' => __(
                    'Customize the format for phone numbers using numeric symbols. You can use "0" to represent numeric placeholders. E.g.: (000) 000-0000. Leave this field blank if you do not wish to use a specific phone format.',
                    'webba-booking-lite'
                ),
            ],
            'advanced'
        ...
        wbk_opt()->add_option(
            ...
            [
                'popup' => __(
                    'Turn on to make the phone field mandatory.',
                    'webba-booking-lite'
                ),
                'checkbox_value' => '3',
                'default' => '',
        ...
        wbk_opt()->add_option(
            ...
            [
                'popup' => __(
                    'Turn on to show booked time slots as "Booked".',
                    'webba-booking-lite'
                ),
            ],
            'advanced'
        ...
        wbk_opt()->add_option(
            ...
            [
                'popup' => __(
                    'When one service is booked, it will automatically lock another one, preventing conflicting bookings.',
                    'webba-booking-lite'
                ),
            ]
        );
        wbk_opt()->add_option(
            ...
            [
                ...
                'dependency' => ['wbk_appointments_auto_lock' => ':checked'],
            ]
        );
        wbk_opt()->add_option(
            ...
            [
                ...
                'extra' => [
                    ...
                    'reduce' => __(
                        'Reduce count of available places',
                        'webba-booking-lite'
                    ),
                ],
                'dependency' => ['wbk_appointments_auto_lock' => ':checked'],
        ...
        wbk_opt()->add_option(
            ...
            [
                'popup' => __(
                    'Turn on to activate the coupon feature in the booking system. Read more about <a rel="noopener" target="_blank" href="https://webba-booking.com/documentation/set-up-frontend-booking-process/coupons/">Coupns setup</a>.',
                    'webba-booking-lite'
                ),
            ],
            'advanced'
        ...
        wbk_opt()->add_option(
            ...
            'select',
            __(
                'Delete unpaid bookings with started payment.',
                'webba-booking-lite'
            ),
            'wbk_appointments_settings_section',
            [
                ...
                'extra' => [
                    'skip' => __(
                        'Do not delete bookings with started transaction',
                        'webba-booking-lite'
                    ),
                    'delete' => __(
                        'Delete bookings with started transaction',
                        'webba-booking-lite'
                    ),
                ],
                'popup' => __(
                    'Choose whether to automatically remove unpaid bookings that have already initiated the payment process.',
                    'webba-booking-lite'
                ),
                'dependency' => [
                    'wbk_appointments_delete_not_paid_mode' =>
                        'on_booking|on_approve',
                ],
            ],
            'advanced'
        );
        wbk_opt()->add_option(
            ...
            [
                'default' => '10',
                'popup' => __(
                    'Specify the time given to the customer (in minutes) for completing the payment before the booking is automatically deleted.',
                    'webba-booking-lite'
                ),
                'dependency' => [
                    'wbk_appointments_delete_not_paid_mode' =>
        ...
        wbk_opt()->add_option(
            ...
            'checkbox',
            __(
                'Allow only one booking per time slot from an email',
                'webba-booking-lite'
            ),
            'wbk_appointments_settings_section',
            [
                'popup' => __(
                    'Turn on to restrict customers from making multiple bookings for the same time slot using the same email address.',
                    'webba-booking-lite'
                ),
            ],
            'advanced'
        ...
        wbk_opt()->add_option(
            ...
            'checkbox',
            __(
                'Allow only one booking per day from an email',
                'webba-booking-lite'
            ),
            'wbk_appointments_settings_section',
            [
                'popup' => __(
                    'Turn on to restrict customers from making multiple bookings for the same day using the same email address.',
                    'webba-booking-lite'
                ),
            ],
            'advanced'
        ...
        wbk_opt()->add_option(
            ...
            'checkbox',
            __(
                'Allow only one booking per service from an email',
                'webba-booking-lite'
            ),
            'wbk_appointments_settings_section',
            [
                'popup' => __(
                    'Turn on to restrict customers from making multiple bookings for the same service using the same email address.',
                    'webba-booking-lite'
                ),
            ],
            'advanced'
        ...
        wbk_opt()->add_option(
            ...
            [
                'default' => '0',
                'popup' => __(
                    'Specify the minutes (X) after which "Awaiting Approval" bookings will be automatically deleted. To disable automatic deletion, set the value to 0.',
                    'webba-booking-lite'
                ),
            ],
            'advanced'
        ...
        wbk_opt()->add_option(
            ...
            'text',
            __(
                'Maximum number of bookings at a specific time',
                'webba-booking-lite'
            ),
            'wbk_appointments_settings_section',
            [
                'popup' => __(
                    'Set the system-wide maximum number of bookings allowed at any given time for all services. Leave it empty for no restrictions.',
                    'webba-booking-lite'
                ),
            ],
            'advanced'
        ...
        wbk_opt()->add_option(
            ...
            'text',
            __(
                'Maximum number of bookings on a specific day',
                'webba-booking-lite'
            ),
            'wbk_appointments_settings_section',
            [
        ...
        wbk_opt()->add_option(
            ...
            [
                'extra' => WBK_Model_Utils::get_services(),
                'popup' => __(
                    '"Select the services for which a whole day will be automatically locked once at least one time slot is booked. 
Note: With autolock turned on, connected service bookings are considered when locking a day."',
                    'webba-booking-lite'
                ),
            ],
            'advanced'
        ...
        wbk_opt()->add_option(
            ...
            [
                'extra' => WBK_Model_Utils::get_services(),
                'popup' => __(
                    '"Select the services for which time slots before and after the booking will be automatically locked.
Note: With autolock turned on, connected service bookings are considered when locking time slots."',
                    'webba-booking-lite'
                ),
            ],
            'advanced'
        ...
        wbk_opt()->add_option(
            ...
            [
                'popup' =>
                    __(
                        'Modify the business hours of specific services on particular dates.',
                        'webba-booking-lite'
                    ) .
                    '<br />' .
                    __(
                        'Example 1: 1 01/15/2023 15:00-18:00',
                        'webba-booking-lite'
                    ) .
                    '<br />' .
                    __(
                        'This indicates that the service with the ID 1 will be available on 01/15/2023 from 15:00 to 18:00.',
                        'webba-booking-lite'
                    ) .
                    '<br />' .
                    __(
                        'Example 2: 01/15/2023 15:00-18:00',
                        'webba-booking-lite'
                    ) .
                    '<br />' .
                    __(
                        'This means that all services will be available on 01/15/2023 from 15:00 to 18:00.',
                        'webba-booking-lite'
                    ),
            ],
            'advanced'
        ...
        wbk_opt()->add_option(
            ...
            [
                'popup' => __(
                    'Turn on to load CSS and JS files only when the booking form shortcode is detected on the page, optimizing performance for non-booking pages.',
                    'webba-booking-lite'
                ),
            ],
            'advanced'
        ...
        wbk_opt()->add_option(
            ...
            [
                ...
                'extra' => [
                    ...
                    'enabled_plus' => __(
                        'Yes (including bookings from neighboring services.)',
                        'webba-booking-lite'
                    ),
                ],
                'popup' => __(
        ...
        wbk_opt()->add_option(
            ...
            [
                ...
                'checkbox_value' => 'true',
                'popup' => __(
                    'Turn on to automatically send a booking confirmation email to the customer after booking.',
                    'webba-booking-lite'
                ),
            ]
        );
        ...
        if (wbk_fs()->is__premium_only() && wbk_fs()->can_use_premium_code()) {
            wbk_opt()->add_option(
                ...
                [
                    ...
                    'checkbox_value' => 'true',
                    'popup' => __(
                        'Turn on to attach iCal file to the booking confirmation email sent to customer.',
                        'webba-booking-lite'
                    ),
                    'dependency' => [
        ...
        wbk_opt()->add_option(
            ...
            'text',
            __(
                'Booking confirmation email subject line (booking done by the customer)',
                'webba-booking-lite'
            ),
            'wbk_email_settings_section',
            [
                ...
                'popup' =>
                    __(
                        'Customize the subject line for the email sent to the customer after they make a booking',
                        'webba-booking-lite'
                    ) .
        ...
        wbk_opt()->add_option(
            ...
            'editor',
            __(
                'Booking confirmation email message (booking done by the customer)',
                'webba-booking-lite'
            ),
            'wbk_email_settings_section',
            [
                'popup' =>
                    __(
                        'Customize the email message sent to the customer after they make a booking. ',
                        'webba-booking-lite'
                    ) .
                    '<a rel="noopener" target="_blank" href="https://webba-booking.com/documentation/placeholders/">' .
                    __('List of available placeholders', 'webba-booking-lite') .
                    '</a>',
                'default' =>
                    '<p>Dear #customer_name,</p><p>You have successfully booked #service_name on #appointment_day at #appointment_time.</p>',
                'dependency' => [
                    'wbk_email_customer_book_status' => ':checked',
                ],
            ]
        ...
        wbk_opt()->add_option(
            ...
            'text',
            __(
                'Booking confirmation email subject line (booking done by the admin)',
                'webba-booking-lite'
            ),
            'wbk_email_settings_section',
            [
                ...
                'popup' =>
                    'Customize the subject line for the email sent to the customer after a booking is made by an admin. <a rel="noopener" target="_blank" href="https://webba-booking.com/documentation/placeholders/">' .
                    __('List of available placeholders', 'webba-booking-lite') .
                    '</a>',
            ]
        );
        wbk_opt()->add_option(
            ...
            'editor',
            __(
                'Booking confirmation email message (booking done by the admin)',
                'webba-booking-lite'
            ),
            'wbk_email_settings_section',
            [
                'popup' =>
                    'Customize the email message sent to the customer after a booking is made by an admin. <a rel="noopener" target="_blank" href="https://webba-booking.com/documentation/placeholders/">' .
                    __('List of available placeholders', 'webba-booking-lite') .
                    '</a>',
                'dependency' => [
                    'wbk_email_customer_book_status' => ':checked',
        ...
        wbk_opt()->add_option(
            ...
            [
                'checkbox_value' => 'true',
                'popup' => __(
                    'Turn on to automatically send a notification email to the customer once their booking request is approved. ',
                    'webba-booking-lite'
                ),
            ],
            'advanced'
        ...
        wbk_opt()->add_option(
            ...
            [
                ...
                'popup' =>
                    'Customize the subject line for the booking approval email. <a rel="noopener" target="_blank" href="https://webba-booking.com/documentation/placeholders/#subjectplaceholders">' .
                    __('List of available placeholders', 'webba-booking-lite') .
                    '</a>',
                'dependency' => [
        ...
        wbk_opt()->add_option(
            ...
            [
                'default' =>
                    '<p>Your booking on #appointment_day at #appointment_time has been approved.</p>',
                'popup' =>
                    'Customize the email message for the booking approval email. <a rel="noopener" target="_blank" href="https://webba-booking.com/documentation/placeholders/#subjectplaceholders">' .
                    __('List of available placeholders', 'webba-booking-lite') .
                    '</a>',
                'dependency' => [
                    'wbk_email_customer_approve_status' => ':checked',
        ...
        wbk_opt()->add_option(
            ...
            'checkbox',
            __(
                'Send admin a copy of booking approval email',
                'webba-booking-lite'
            ),
            'wbk_email_settings_section',
            [
                'checkbox_value' => 'true',
                'popup' => __(
                    'Turn on if you want to send a copy of the booking approval email to the admin. Please note that the copy will be sent only if the booking is approved via the approval link.',
                    'webba-booking-lite'
                ),
                'dependency' => [
                    'wbk_email_customer_approve_status' => ':checked',
        ...
        wbk_opt()->add_option(
            ...
            'checkbox',
            __(
                'Send booking cancelation email (to admin)',
                'webba-booking-lite'
            ),
            'wbk_email_settings_section',
            [
                'checkbox_value' => 'true',
                'popup' => __(
                    'Turn on to automatically send a booking cancelation email to the admin after a booking is canceled.',
                    'webba-booking-lite'
                ),
            ],
            'advanced'
        ...
        wbk_opt()->add_option(
            ...
            [
                ...
                'popup' =>
                    'Customize the subject line for the booking cancelation email sent to the admin. <a rel="noopener" target="_blank" href="https://webba-booking.com/documentation/placeholders/">' .
                    __('List of available placeholders', 'webba-booking-lite') .
                    '</a>',
                'dependency' => [
        ...
        wbk_opt()->add_option(
            ...
            [
                'default' =>
                    '<p>#customer_name canceled the appointment with #service_name on #appointment_day at #appointment_time</p>',
                'dependency' => [
                    'wbk_email_adimn_appointment_cancel_status' => ':checked',
                ],
                'popup' =>
                    'Customize the email message for the booking cancelation email sent to the admin. <a rel="noopener" target="_blank" href="https://webba-booking.com/documentation/placeholders/">' .
                    __('List of available placeholders', 'webba-booking-lite') .
                    '</a>',
            ],
            'advanced'
        ...
        wbk_opt()->add_option(
            ...
            'checkbox',
            __(
                'Send booking cancelation email (to customer)',
                'webba-booking-lite'
            ),
            'wbk_email_settings_section',
            [
                'checkbox_value' => 'true',
                'popup' => __(
                    'Turn on to automatically send a booking cancelation email to the customer after a booking is canceled.',
                    'webba-booking-lite'
                ),
            ],
            'advanced'
        ...
        wbk_opt()->add_option(
            ...
            [
                ...
                'popup' =>
                    'Customize the subject line for the booking cancelation email sent to the customer. <a rel="noopener" target="_blank" href="https://webba-booking.com/documentation/placeholders/">' .
                    __('List of available placeholders', 'webba-booking-lite') .
                    '</a>',
            ],
            'advanced'
        ...
        wbk_opt()->add_option(
            ...
            'editor',
            __(
                'Booking cancelation email message (cancelation done by the admin)',
                'webba-booking-lite'
            ),
            'wbk_email_settings_section',
            [
                ...
                'default' =>
                    '<p>Your appointment with #service_name on #appointment_day at #appointment_time has been canceled</p>',
                'popup' =>
                    'Customize the email message for the booking cancelation email sent to the customer when the cancellation is initiated by the admin. <a rel="noopener" target="_blank" href="https://webba-booking.com/documentation/placeholders/">' .
                    __('List of available placeholders', 'webba-booking-lite') .
                    '</a>',
            ],
            'advanced'
        ...
        wbk_opt()->add_option(
            ...
            'editor',
            __(
                'Booking cancelation email message  (cancelation done by the customer)',
                'webba-booking-lite'
            ),
            'wbk_email_settings_section',
            [
                ...
                'default' =>
                    '<p>Your appointment with #service_name on #appointment_day at #appointment_time has been canceled</p>',
                'popup' =>
                    'Customize the email message for the booking cancelation email sent to the customer when the cancellation is initiated by the customer. <a rel="noopener" target="_blank" href="https://webba-booking.com/documentation/placeholders/">' .
                    __('List of available placeholders', 'webba-booking-lite') .
                    '</a>',
            ],
            'advanced'
        ...
        wbk_opt()->add_option(
            ...
            'checkbox',
            __(
                'Send booking cancelation email (to other customers in the group booking)',
                'webba-booking-lite'
            ),
            'wbk_email_settings_section',
            [
                'checkbox_value' => 'true',
                'popup' => __(
                    'Turn on to automatically send a booking cancelation email to all the customers added to the group booking.',
                    'webba-booking-lite'
                ),
            ],
            'advanced'
        ...
        wbk_opt()->add_option(
            ...
            [
                'checkbox_value' => 'true',
                'popup' =>
                    'Customize the email message for the booking cancelation email sent to the customers in the group booking. <a rel="noopener" target="_blank" href="https://webba-booking.com/documentation/placeholders/">' .
                    __('List of available placeholders', 'webba-booking-lite') .
                    '</a>',
                'dependency' => [
        ...
        wbk_opt()->add_option(
            ...
            [
                ...
                'default' => 'true',
                'popup' => __(
                    'Turn on to automatically send a booking confirmation email to the admin.',
                    'webba-booking-lite'
                ),
            ]
        );
        if (wbk_fs()->is__premium_only() && wbk_fs()->can_use_premium_code()) {
            wbk_opt()->add_option(
                ...
                [
                    ...
                    'checkbox_value' => 'true',
                    'popup' => __(
                        'Turn on to attach iCal file to the booking confirmation email sent to the admin.',
                        'webba-booking-lite'
                    ),
                ]
            );
        ...
        wbk_opt()->add_option(
            ...
            [
                ...
                'dependency' => ['wbk_email_admin_book_status' => ':checked'],
                'popup' =>
                    'Customize the subject line for the email sent to the admin after a booking has been made. List of available placeholders. <a rel="noopener" target="_blank" href="https://webba-booking.com/documentation/placeholders/">' .
                    __('List of available placeholders', 'webba-booking-lite') .
                    '</a>',
            ]
        );
        ...
        wbk_opt()->add_option(
            ...
            [
                'default' =>
                    '<p>Details of booking:</p><p>Date: #appointment_day<br/>Time: #appointment_time<br/>Customer name: #customer_name<br/>Customer phone: #customer_phone<br/>Customer email: #customer_email<br/>Customer comment: #customer_comment</p><p></p>',
                'dependency' => ['wbk_email_admin_book_status' => ':checked'],
                'popup' =>
                    'Customize the email message sent to the admin after a booking has been made. List of available placeholders. <a rel="noopener" target="_blank" href="https://webba-booking.com/documentation/placeholders/">' .
                    __('List of available placeholders', 'webba-booking-lite') .
                    '</a>',
            ]
        );
        ...
        wbk_opt()->add_option(
            ...
            [
                'checkbox_value' => 'true',
                'popup' => __(
                    'Turn on to automatically send an email notification to the administrator when a payment for a booking is received. ',
                    'webba-booking-lite'
                ),
            ],
            'advanced'
        ...
        wbk_opt()->add_option(
            ...
            [
                ...
                'popup' =>
                    'Customize the subject line for the payment received email sent to the admin. <a rel="noopener" target="_blank" href="https://webba-booking.com/documentation/placeholders/">' .
                    __('List of available placeholders', 'webba-booking-lite') .
                    '</a>',
            ],
            'advanced'
        ...
        wbk_opt()->add_option(
            ...
            [
                'popup' =>
                    'Customize the email message for the payment received email sent to the admin. <a rel="noopener" target="_blank" href="https://webba-booking.com/documentation/placeholders/">' .
                    __('List of available placeholders', 'webba-booking-lite') .
                    '</a>',
        ...
        wbk_opt()->add_option(
            ...
            [
                'checkbox_value' => 'true',
                'default' =>
                    'Payment from #customer_name for booking of #service_name on #appointment_day at #appointment_time received. <br>Total amount: #total_amount',
                'popup' => __(
                    'Turn on to automatically send an email notification to the customer when a payment for a booking is received. ',
                    'webba-booking-lite'
                ),
            ],
            'advanced'
        ...
        wbk_opt()->add_option(
            ...
            [
                ...
                'popup' =>
                    'Customize the subject line for the payment received email sent to the customer. <a rel="noopener" target="_blank" href="https://webba-booking.com/documentation/placeholders/">' .
                    __('List of available placeholders', 'webba-booking-lite') .
                    '</a>',
            ],
            'advanced'
        ...
        wbk_opt()->add_option(
            ...
            [
                ...
                'popup' =>
                    'Customize the email message for the payment received email sent to the customer. <a rel="noopener" target="_blank" href="https://webba-booking.com/documentation/placeholders/">' .
                    __('List of available placeholders', 'webba-booking-lite') .
                    '</a>',
            ],
            'advanced'
        ...
        wbk_opt()->add_option(
            ...
            'checkbox',
            __(
                'Send status "Arrived" email (to customer)',
                'webba-booking-lite'
            ),
            'wbk_email_settings_section',
            [
                'checkbox_value' => 'true',
                'popup' => __(
                    'Turn on to automatically send an email notification to the customer when the status of their booking is changed to "Arrived."',
                    'webba-booking-lite'
                ),
            ],
            'advanced'
        ...
        wbk_opt()->add_option(
            ...
            [
                ...
                'popup' =>
                    'Customize the subject line for the status "Arrived" email sent to the customer. <a rel="noopener" target="_blank" href="https://webba-booking.com/documentation/placeholders/">' .
                    __('List of available placeholders', 'webba-booking-lite') .
                    '</a>',
            ],
            'advanced'
        ...
        wbk_opt()->add_option(
            ...
            [
                'popup' =>
                    'Customize the email message for the status "Arrived" email sent to the customer. <a rel="noopener" target="_blank" href="https://webba-booking.com/documentation/placeholders/">' .
                    __('List of available placeholders', 'webba-booking-lite') .
                    '</a>',
                'dependency' => [
                    'wbk_email_customer_arrived_status' => ':checked',
        ...
        wbk_opt()->add_option(
            ...
            [
                'checkbox_value' => 'true',
                'popup' => __(
                    'Turn on to send admin automatic email reminders for upcoming bookings.',
                    'webba-booking-lite'
                ),
            ],
            'advanced'
        ...
        wbk_opt()->add_option(
            ...
            [
                'popup' =>
                    'Customize the subject line for reminder email sent to the admin. <a rel="noopener" target="_blank" href="https://webba-booking.com/documentation/placeholders/">' .
                    __('List of available placeholders', 'webba-booking-lite') .
                    '</a>',
                'dependency' => ['wbk_email_admin_daily_status' => ':checked'],
            ],
            'advanced'
        );
        ...
        wbk_opt()->add_option(
            ...
            [
                'popup' =>
                    'Customize the email message for reminder email sent to the admin. <a rel="noopener" target="_blank" href="https://webba-booking.com/documentation/placeholders/">' .
                    __('List of available placeholders', 'webba-booking-lite') .
                    '</a>',
                'dependency' => ['wbk_email_admin_daily_status' => ':checked'],
            ],
        ...
        wbk_opt()->add_option(
            ...
            [
                'checkbox_value' => 'true',
                'popup' => __(
                    'Turn on to send customers automatic email reminders for their upcoming bookings.',
                    'webba-booking-lite'
                ),
            ],
            'advanced'
        ...
        wbk_opt()->add_option(
            ...
            [
                ...
                'popup' =>
                    'Customize the subject line for reminder email sent to the customer. <a rel="noopener" target="_blank" href="https://webba-booking.com/documentation/placeholders/">' .
                    __('List of available placeholders', 'webba-booking-lite') .
                    '</a>',
            ],
            'advanced'
        ...
        wbk_opt()->add_option(
            ...
            [
                'popup' =>
                    'Customize the email message for reminder email sent to the customer. <a rel="noopener" target="_blank" href="https://webba-booking.com/documentation/placeholders/">' .
                    __('List of available placeholders', 'webba-booking-lite') .
                    '</a>',
                'dependency' => [
                    'wbk_email_customer_daily_status' => ':checked',
        ...
        wbk_opt()->add_option(
            ...
            'checkbox',
            __(
                'Send reminders only for approved bookings.',
                'webba-booking-lite'
            ),
            'wbk_email_settings_section',
            [
                ...
                'checkbox_value' => 'true',
                'popup' => __(
                    'Turn on to send reminder email notifications only for approved bookings.',
                    'webba-booking-lite'
                ),
            ],
            'advanced'
        ...
        wbk_opt()->add_option(
            ...
            'select',
            __(
                'Send invoice to a customer (HTML format) ',
                'webba-booking-lite'
            ),
            'wbk_email_settings_section',
            [
                ...
                'extra' => [
                    ...
                    'onbooking' => __(
                        'Send invoice on booking',
                        'webba-booking-lite'
                    ),
                    'onapproval' => __(
                        'Send invoice on approval',
                        'webba-booking-lite'
                    ),
                    'onpayment' => __(
                        'Send invoice on payment complete',
                        'webba-booking-lite'
                    ),
                ],
                'popup' => __(
                    'Choose whether you would like to send an invoice to the customer and specify when the invoice email should be sent.',
                    'webba-booking-lite'
                ),
            ],
            'advanced'
        ...
        wbk_opt()->add_option(
            ...
            [
                'dependency' => [
                    'wbk_email_customer_send_invoice' =>
                        'onbooking|onapproval|onpayment',
                ],
                'default' => __('Invoice', 'webba-booking-lite'),
                'popup' =>
                    'Customize the subject line for invoice email. <a rel="noopener" target="_blank" href="https://webba-booking.com/documentation/placeholders/">' .
                    __('List of available placeholders', 'webba-booking-lite') .
                    '</a>',
            ],
            'advanced'
        ...
        wbk_opt()->add_option(
            ...
            [
                ...
                'default' => '1',
                'popup' => __(
                    'Set the starting number for your invoices. Use the placeholder #invoice_number in your notifications. Each time a customer makes a payment, the value of this option will be increased by one.'
                ),
            ],
            'advanced'
        );
        wbk_opt()->add_option(
            ...
            [
                ...
                'checkbox_value' => 'true',
                'popup' => __(
                    'Turn on if you want to send a copy of the invoice email to the admin.',
                    'webba-booking-lite'
                ),
            ],
            'advanced'
        ...
        wbk_opt()->add_option(
            ...
            'text',
            __(
                'Notification subject (when booking changes)',
                'webba-booking-lite'
            ),
            'wbk_email_settings_section',
            [
                'popup' => __(
                    'Customize the subject line for booking changes notification email.',
                    'webba-booking-lite'
                ),
            ],
            'advanced'
        ...
        wbk_opt()->add_option(
            ...
            [
                'checkbox_value' => 'true',
                'popup' => __(
                    'When Enabled:Customer Notifications: The reply-to email address is set to the email specified in the service settings.
Admin Notifications: The reply-to email address is set to the customer\'s email address. When Disabled: The \'From: email\' value is used as the reply-to address for notifications.',
                    'webba-booking-lite'
                ),
            ],
            'advanced'
        ...
        wbk_opt()->add_option(
            ...
            [
                'popup' => __(
                    'Enter the email addresses where you want to receive copies of admin notifications. Separate multiple email addresses with comma.',
                    'webba-booking-lite'
                ),
            ],
            'advanced'
        ...
        wbk_opt()->add_option(
            ...
            [
                'default' => '30',
                'popup' => __(
                    'Used only for dropdown date select',
                    'webba-booking-lite'
                ),
                'dependency' => ['wbk_date_input' => 'dropdown'],
            ]
        );
        wbk_opt()->add_option(
            ...
            [
                'default' => '360',
                'popup' => __(
                    'Specify the number of dates displayed in the calendar.',
                    'webba-booking-lite'
                ),
            ],
            'advanced'
        ...
        wbk_opt()->add_option(
            ...
            [
                'popup' => __(
                    'Choose between displaying only the start time or both the start and end times in the time slots.',
                    'webba-booking-lite'
                ),
                'default' => 'start',
                'extra' => [
        ...
        wbk_opt()->add_option(
            ...
            [
                'default' => 'Semicolon',
                'popup' => __(
                    'If your date format includes a comma, use a semicolon. Otherwise, select the comma.',
                    'webba-booking-lite'
                ),
                'extra' => [
        ...
        wbk_opt()->add_option(
            ...
            [
                ...
                'default' => 'yes',
                'popup' => __(
                    'Turn off if other plugins in your WordPress installation are using the pickadate date picker.',
                    'webba-booking-lite'
                ),
            ],
            'advanced'
        ...
        wbk_opt()->add_option(
            ...
            [
                'checkbox_value' => 'true',
                'popup' => __(
                    'Turn on to avoid adding tax to the deposit. Important note: when this is turned on, do not use subtotal and tax placeholders.',
                    'webba-booking-lite'
                ),
            ],
            'advanced'
        ...
        wbk_opt()->add_option(
            ...
            [
                'default' => '',
                'popup' => __(
                    'Enter a comma-separated list of placeholders to remove from the string if they are not replaced with values. This is useful if you are using different custom fields for services and as a result some custom field placeholders are not replaced.',
                    'webba-booking-lite'
                ),
            ],
            'advanced'
        ...
        wbk_opt()->add_option(
            ...
            [
                ...
                'popup' => __(
                    'Service label on the booking form.',
                    'webba-booking-lite'
                ),
            ]
        );
        ...
        wbk_opt()->add_option(
            ...
            [
                'default' => '',
                'popup' => __(
                    'Text above the booking form. List of available placeholders.',
                    'webba-booking-lite'
                ),
            ],
            'advanced'
        ...
        wbk_opt()->add_option(
            ...
            [
                ...
                'popup' => __(
                    'Name label on the booking form.',
                    'webba-booking-lite'
                ),
            ]
        );
        ...
        wbk_opt()->add_option(
            ...
            [
                ...
                'popup' => __(
                    'Comment label on the booking form.',
                    'webba-booking-lite'
                ),
            ]
        );
        ...
        wbk_opt()->add_option(
            ...
            [
                ...
                'popup' => __(
                    'Quantity label on the booking form for group bookings. Available placeholders: #service',
                    'webba-booking-lite'
                ),
            ]
        );
        ...
        wbk_opt()->add_option(
            ...
            [
                'default' => '',
                'popup' => __(
                    'Customize the thank you message displayed after a booking is made. Leave it empty to use the default formatted thank you message.',
                    'webba-booking-lite'
                ),
            ],
            'advanced'
        ...
        wbk_opt()->add_option(
            ...
            [
                'default' => __(
                    'Unfortunately we were unable to meet your search criteria. Please change the criteria and try again.',
                    'webba-booking-lite'
                ),
                'popup' => __(
                    'Message displayed when no time slots are found for the selected service and date.',
                    'webba-booking-lite'
                ),
            ],
            'advanced'
        ...
        wbk_opt()->add_option(
            ...
            [
                ...
                'popup' => __(
                    'Error message that appears if an issue occurs with the Stripe payment method. To show this message go to Stripe -> Advanced Settings and turn on "override Stripe card element error messages".',
                    'webba-booking-lite'
                ),
            ],
            'advanced'
        ...
        */
        ...
        wbk_opt()->add_option(
            ...
            [
                'default' => __(
                    'Booking not added to cart',
                    'webba-booking-lite'
                ),
                'popup' => __(
                    'Error message that appears if an issue occurs with adding a booking to WooCommerce cart.',
                    'webba-booking-lite'
                ),
            ],
            'advanced'
        ...
        wbk_opt()->add_option(
            ...
            [
                ...
                'popup' => __(
                    'Message above the payment details.',
                    'webba-booking-lite'
                ),
            ],
            'advanced'
        ...
        wbk_opt()->add_option(
            ...
            [
                'default' => '$#price',
                'popup' => __(
                    'Price format on the booking form. Required placeholder: #price. E.g.: $#price.',
                    'webba-booking-lite'
                ),
            ]
        );
        wbk_opt()->add_option(
            ...
            [
                ...
                'popup' => __(
                    'Label for the subtotal amount in payment details',
                    'webba-booking-lite'
                ),
            ],
            'advanced'
        ...
        wbk_opt()->add_option(
            ...
            [
                ...
                'popup' => __(
                    'Label for the service fee in payment details',
                    'webba-booking-lite'
                ),
            ],
            'advanced'
        ...
        wbk_opt()->add_option(
            ...
            [
                'checkbox_value' => 'yes',
                'popup' => __(
                    'Turn on to allow users to attach files in the booking form. Please include the file input field in the custom form. For more information, see <a href="https://webba-booking.com/documentation/set-up-frontend-booking-process/using-custom-fields-in-the-booking-form/" target="_blank" rel="noopener noreferrer">Custom fields</a>.',
                    'webba-booking-lite'
                ),
            ],
            'advanced'
        ...
        wbk_opt()->add_option(
            ...
            [
                ...
                'default' => 'yes',
                'popup' => __(
                    'Highly Recommended: Turn this on to automatically delete the attachment as soon as the notification is sent.',
                    'webba-booking-lite'
                ),
            ],
            'advanced'
        ...
        wbk_opt()->add_option(
            ...
            [
                ...
                'default' => 'true',
                'popup' => __(
                    'IMPORTANT: if you disable this option, make sure to not cache pages with the booking form.',
                    'webba-booking-lite'
                ),
            ],
            'advanced'
        ...
        wbk_opt()->add_option(
            ...
            'text',
            __(
                'Block time slots after X hours from the current time',
                'webba-booking-lite'
            ),
            'wbk_appointments_settings_section',
            [
                'default' => '0',
                'popup' => __(
                    'Set 0 to not disable time slots',
                    'webba-booking-lite'
                ),
            ],
            'advanced'
        ...
        wbk_opt()->add_option(
            ...
            [
                'popup' => __(
                    'Turn on to align the booking system with GDPR guidelines, providing enhanced data protection and privacy for customer information.',
                    'webba-booking-lite'
                ),
            ]
        );
        ...
        wbk_opt()->add_option(
            ...
            [
                'popup' => __(
                    'Specify the number of minutes after the end of the booking when the status should be automatically changed to "Arrived." Leave the field empty to keep the status unchanged.',
                    'webba-booking-lite'
                ),
            ],
            'advanced'
        ...
        wbk_opt()->add_option(
            ...
            [
                ...
                'popup' => __(
                    'Message shown when payment with PayPal is canceled',
                    'webba-booking-lite'
                ),
            ],
            'advanced'
        ...
        wbk_opt()->add_option(
            ...
            [
                'default' => __(
                    'Please, enter your email to confirm cancelation',
                    'webba-booking-lite'
                ),
                'popup' => __(
                    'Text of the cancelation form label',
                    'webba-booking-lite'
                ),
            ],
            'advanced'
        ...
        wbk_opt()->add_option(
            ...
            [
                ...
                'popup' => __(
                    'Cancellation form title. Appears on the sidebar (on desktop) and top bar (on mobile)',
                    'webba-booking-lite'
                ),
            ],
            'advanced'
        ...
        wbk_opt()->add_option(
            ...
            [
                'default' => __('Booking', 'webba-booking-lite'),
                'popup' => __(
                    '"Message shown when customers pay for a booking or cancel their booking using the link sent in the email notification.
Available placeholders: #name (customer name), #id (appointment id), #service (service name), #date (appointment date), #time (appointment time), #dt (appointment date and time), #start_end (appointment time in start-end format)."',
                    'webba-booking-lite'
                ),
            ],
            'advanced'
        ...
        wbk_opt()->add_option(
            ...
            'text',
            __(
                'Warning message on cancel booking (reason: paid booking)',
                'webba-booking-lite'
            ),
            'wbk_translation_settings_section',
            [
                'default' => __(
                    'Paid booking can\'t be canceled.',
                    'webba-booking-lite'
                ),
                'popup' => __(
                    'Displayed when customer tries to cancel paid booking.',
                    'webba-booking-lite'
                ),
            ],
            'advanced'
        ...
        wbk_opt()->add_option(
            ...
            'text',
            __(
                'Warning message on cancel booking (buffer)',
                'webba-booking-lite'
            ),
            'wbk_translation_settings_section',
            [
                ...
                'popup' => __(
                    'Message shown when a customer tries to cancel a booking within a time frame that does not allow cancellations. Buffer time is set in Booking rules -> Cancellation buffer (in minutes)',
                    'webba-booking-lite'
                ),
            ],
            'advanced'
        ...
        wbk_opt()->add_option(
            ...
            [
                'default' => __(
                    'Your booking has been cncelled.',
                    'webba-booking-lite'
                ),
                'popup' => __(
                    'Text of the shown to a customer when booking is cancelled.',
                    'webba-booking-lite'
                ),
            ],
            'advanced'
        ...
        wbk_opt()->add_option(
            ...
            'text',
            __(
                'Add to customer\'s Google Calendar button text',
                'webba-booking-lite'
            ),
            'wbk_translation_settings_section',
            [
                ...
                'popup' => __(
                    'Text of the link included in the email notification',
                    'webba-booking-lite'
                ),
            ],
            'advanced'
        ...
        wbk_opt()->add_option(
            ...
            'text',
            __(
                'Google calendar event adding success message',
                'webba-booking-lite'
            ),
            'wbk_translation_settings_section',
            [
                'default' => __(
                    'Booking data added to Google Calendar.',
                    'webba-booking-lite'
                ),
                'popup' => __(
                    'Message shown when booking is added to the Google Calendar.',
                    'webba-booking-lite'
                ),
            ],
            'advanced'
        ...
        wbk_opt()->add_option(
            ...
            'text',
            __(
                'Google calendar event adding error message',
                'webba-booking-lite'
            ),
            'wbk_translation_settings_section',
            [
                'default' => __(
                    'Appointment data not added to Google Calendar.',
                    'webba-booking-lite'
                ),
                'popup' => __(
                    'Message shown when there was an issue with adding a booking to the Google Calendar.',
                    'webba-booking-lite'
                ),
            ],
            'advanced'
        ...
        wbk_opt()->add_option(
            ...
            [
                ...
                'popup' => __(
                    'Message shown when booking link (cancelation, approval, payment) is invalid in the email notification.',
                    'webba-booking-lite'
                ),
            ],
            'advanced'
        ...
        wbk_opt()->add_option(
            ...
            [
                ...
                'popup' => __(
                    'Message shown when user limit is reached. Adjust the user booking limits in the Settings -> Booking Rules.',
                    'webba-booking-lite'
                ),
            ],
            'advanced'
        ...
        if (wbk_fs()->is__premium_only() && wbk_fs()->can_use_premium_code()) {
            wbk_opt()->add_option(
                ...
                [
                    'popup' =>
                        'Enter the publishable API key provided by Stripe for your integration. <a href="https://stripe.com/docs/keys" rel="noopener" target="_blank">Read more on how to set up Stripe integration.</a>',
                ]
            );
            wbk_opt()->add_option(
            ...
            wbk_opt()->add_option(
                ...
                [
                    ...
                    'extra' => [
                        ...
                        'shortcode' => __(
                            'Only on the booking page (not recommended)',
                            'webba-booking-lite'
                        ),
                    ],
                ],
            ...
            wbk_opt()->add_option(
                ...
                [
                    ...
                    'extra' => [
                        ...
                        'old' => __(
                            'Yes, load version 6.21.1 (not recommended)',
                            'webba-booking-lite'
                        ),
                        'no' => __('No', 'webba-booking-lite'),
                    ],
            ...
            wbk_opt()->add_option(
                ...
                'select',
                __(
                    'Set status after booking is paid with Stripe to',
                    'webba-booking-lite'
                ),
                'wbk_stripe_settings_section',
                [
                    'default' => 'based',
                    'popup' => __(
                        'Choose how to update the status after booking is paid with Stripe. To keep the current status unchanged, select "Based on status before payment". ',
                        'webba-booking-lite'
                    ),
                    'extra' => [
                        'based' => __(
                            'Based on status before payment',
                            'webba-booking-lite'
                        ),
                        'paid' => __(
        ...
        if (wbk_fs()->is__premium_only() && wbk_fs()->can_use_premium_code()) {
            wbk_opt()->add_option(
                ...
                [
                    'popup' => __(
                        'Product ID. <a rel="noopener" target="_blank" href="https://webba-booking.com/documentation/payment/steps-to-setup-the-integration-of-woocommerce-with-webba/">Read more</a>
 .',
                        'webba-booking-lite'
                    ),
                ]
            ...
            wbk_opt()->add_option(
                ...
                'checkbox',
                __(
                    'Prefill fields in WooCommerce checkout with the data used in the booking form',
                    'webba-booking-lite'
                ),
                'wbk_woo_settings_section',
                [
        ...
        if (wbk_fs()->is__premium_only() && wbk_fs()->can_use_premium_code()) {
            wbk_opt()->add_option(
                ...
                [
                    'popup' =>
                        'Enter the Zoom Client ID. <a rel="noopener" target="_blank" href="https://webba-booking.com/documentation/integrations/integration-with-zoom/">Read more on how to set up Zoom integration.</a>',
                ]
            );
            wbk_opt()->add_option(
                ...
                [
                    'popup' =>
                        'Enter the Zoom Client secret. <a rel="noopener" target="_blank" href="https://webba-booking.com/documentation/integrations/integration-with-zoom/">Read more on how to set up Zoom integration.</a>',
                ]
            );
            wbk_opt()->add_option(
                'wbk_zoom_auth_stat',
        ...
        wbk_opt()->add_option(
            ...
            [
                'default' => '#name',
                'popup' => __(
                    'Use this option to display custom fields alongside the customer name in the appointments table and schedules. For instance, you can show the customer\'s name and last name by using the placeholder #name #field_lastname. In this example, the last name is stored in a custom field with the ID "lastname". Remember to include the #name placeholder in the value of this option for it to work correctly.',
                    'webba-booking-lite'
                ),
            ],
            'advanced'
        ...
        wbk_opt()->add_option(
            ...
            [
                ...
                'popup' => __(
                    'Select how the date will be displayed on the Appointments page in the admin area.',
                    'webba-booking-lite'
                ),
            ]
        );
        ...
        wbk_opt()->add_option(
            ...
            [
                'popup' => __(
                    'Select how to display time slots on the Schedule page.',
                    'webba-booking-lite'
                ),
                'default' => 'start',
                'extra' => [
        ...
        wbk_opt()->add_option(
            ...
            [
                'popup' => __(
                    'Enter a comma-separated list of custom field IDs. To set custom column headers, use square brackets with the desired titles. For example: custom-field1[Title 1],custom-field2[Title 2].',
                    'webba-booking-lite'
                ),
            ],
            'advanced'
        ...
        wbk_opt()->add_option(
            ...
            [
                'default' => '30',
                'popup' => __(
                    'Set the default number of days to be displayed on the appointment page. To improve performance, consider using a lower value.',
                    'webba-booking-lite'
                ),
            ]
        );
        ...
        if (wbk_fs()->is__premium_only() && wbk_fs()->can_use_premium_code()) {
            ...
            wbk_opt()->add_option(
                ...
                [
                    'checkbox_value' => 'true',
                    'dependency' => ['wbk_sms_send_on_booking' => ':checked'],
                    'popup' => __(
            ...
            wbk_opt()->add_option(
                ...
                'wbk_sms_settings_section',
                [
                    'dependency' => ['wbk_sms_send_reminder' => ':checked'],
                    'default' => '1',
                    'popup' => __(
            ...
            wbk_opt()->add_option(
                ...
                [
                    'dependency' => ['wbk_sms_send_reminder' => ':checked'],
                    'default' => __(
                        'Dea #customer_name, we would like to remind that you have booked the #service_name tomorrow at #appointment_time.',
                        'webba-booking-lite'
                    ),
                    'popup' =>
            ...
            wbk_opt()->add_option(
                ...
                'wbk_sms_settings_section',
                [
                    'dependency' => ['wbk_sms_send_on_approval' => ':checked'],
                    'default' => __(
        ...
        wbk_opt()->add_option(
            ...
            [
                ...
                'popup' => __(
                    'Services title in the booking form sidebar.',
                    'webba-booking-lite'
                ),
            ]
        );
        wbk_opt()->add_option(
            ...
            [
                ...
                'popup' => __(
                    'Date and time title in the booking form sidebar.',
                    'webba-booking-lite'
                ),
            ]
        );
        wbk_opt()->add_option(
            ...
            [
                ...
                'popup' => __(
                    'User details title in the booking form sidebar.',
                    'webba-booking-lite'
                ),
            ]
        );
        ...
        wbk_opt()->add_option(
            ...
            [
                ...
                'popup' => __(
                    'On mobile, you\'ll find a step separator. For instance, \'1 of 3\' (steps). Translate the seperator "of."',
                    'webba-booking-lite'
                ),
            ],
            'advanced'
        ...
        wbk_opt()->add_option(
            ...
            [
                ...
                'popup' => __(
                    'Minutes label in the services step.',
                    'webba-booking-lite'
                ),
            ],
            'advanced'
        ...
        wbk_opt()->add_option(
            ...
            [
                ...
                'popup' => __(
                    'Text for the "Your local time" checkbox.',
                    'webba-booking-lite'
                ),
            ],
            'advanced'
        ...
        wbk_opt()->add_option(
            ...
            [
                ...
                'popup' => __(
                    'Text shown when user selects PayPal payment method and will be redirected to PayPal to approve the payment.',
                    'webba-booking-lite'
                ),
            ],
            'advanced'
        ...
        wbk_opt()->add_option(
            ...
            [
                ...
                'popup' => __(
                    'Text shown on the group service time slots. For example "Available: 10".',
                    'webba-booking-lite'
                ),
            ],
            'advanced'
        ...
        wbk_opt()->add_option(
            ...
            [
                ...
                'popup' => __(
                    'Label for payment approval button.',
                    'webba-booking-lite'
                ),
            ],
            'advanced'
