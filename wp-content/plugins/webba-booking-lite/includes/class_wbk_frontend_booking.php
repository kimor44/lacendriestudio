...
class WBK_Frontend_Booking
{
    ...
    public function param_processing()
    {
        ...
        if (isset($_GET['ggeventadd'])) {
            ...
            $appointment_ids = WBK_Db_Utils::getAppointmentIdsByGroupToken(
                $ggeventadd
            );
    ...
    {
        $get_processing = WBK_Renderer::load_template(
            'frontend/get_parameters_processing',
            [],
            false
        );
        if ($get_processing != '') {
        ...
        extract(shortcode_atts(['multiservice' => 'no'], $attr));
            ...
            if ($multiservice != 'yes') {
                if ($category_list == 'yes') {
                    $templates = [
                        ...
                        'frontend_v5/service_single_radio' => [
                            $service_ids,
                            false,
                            true,
                        ],
            ...
            $this->scenario[] = [
                'title' => esc_html(
                    get_option(
                        ...
                        __('Date and time', 'webba-booking-lite')
                    )
                ),
                'slug' => 'date_time',
                'templates' => ['frontend_v5/date_time' => [false]],
