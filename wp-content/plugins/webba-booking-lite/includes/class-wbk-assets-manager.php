...
class WBK_Assets_Manager
{
    ...
    public function wp_enqueue_scripts()
    {
        ...
        $translation_array = array(
            ...
            'january'                   => __( 'January', 'webba-booking-lite' ),
            'february'                  => __( 'February', 'webba-booking-lite' ),
            'march'                     => __( 'March', 'webba-booking-lite' ),
            'april'                     => __( 'April', 'webba-booking-lite' ),
            'may'                       => __( 'May', 'webba-booking-lite' ),
            'june'                      => __( 'June', 'webba-booking-lite' ),
            'july'                      => __( 'July', 'webba-booking-lite' ),
            'august'                    => __( 'August', 'webba-booking-lite' ),
            'september'                 => __( 'September', 'webba-booking-lite' ),
            'october'                   => __( 'October', 'webba-booking-lite' ),
            'november'                  => __( 'November', 'webba-booking-lite' ),
            'december'                  => __( 'December', 'webba-booking-lite' ),
            'jan'                       => __( 'Jan', 'webba-booking-lite' ),
            'feb'                       => __( 'Feb', 'webba-booking-lite' ),
            'mar'                       => __( 'Mar', 'webba-booking-lite' ),
            'apr'                       => __( 'Apr', 'webba-booking-lite' ),
            'mays'                      => __( 'May', 'webba-booking-lite' ),
            'jun'                       => __( 'Jun', 'webba-booking-lite' ),
            'jul'                       => __( 'Jul', 'webba-booking-lite' ),
            'aug'                       => __( 'Aug', 'webba-booking-lite' ),
            'sep'                       => __( 'Sep', 'webba-booking-lite' ),
            'oct'                       => __( 'Oct', 'webba-booking-lite' ),
            'nov'                       => __( 'Nov', 'webba-booking-lite' ),
            'dec'                       => __( 'Dec', 'webba-booking-lite' ),
            'sunday'                    => __( 'Sunday', 'webba-booking-lite' ),
            'monday'                    => __( 'Monday', 'webba-booking-lite' ),
            'tuesday'                   => __( 'Tuesday', 'webba-booking-lite' ),
            'wednesday'                 => __( 'Wednesday', 'webba-booking-lite' ),
            'thursday'                  => __( 'Thursday', 'webba-booking-lite' ),
            'friday'                    => __( 'Friday', 'webba-booking-lite' ),
            'saturday'                  => __( 'Saturday', 'webba-booking-lite' ),
            'sun'                       => __( 'Sun', 'webba-booking-lite' ),
            'mon'                       => __( 'Mon', 'webba-booking-lite' ),
            'tue'                       => __( 'Tue', 'webba-booking-lite' ),
            'wed'                       => __( 'Wed', 'webba-booking-lite' ),
            'thu'                       => __( 'Thu', 'webba-booking-lite' ),
            'fri'                       => __( 'Fri', 'webba-booking-lite' ),
            'sat'                       => __( 'Sat', 'webba-booking-lite' ),
            'today'                     => __( 'Today', 'webba-booking-lite' ),
            'clear'                     => __( 'Clear', 'webba-booking-lite' ),
            'close'                     => __( 'Close', 'webba-booking-lite' ),
