...
?>
<div  style="display:none;" class="plugion_property_container_add_form" data-table="<?php echo $slug; ?>">
    <div class="plugion_property_header">
        <span class="plugion_properties_title">
            <?php
                echo plugion_translate_string( 'New' ) . ' ' . Plugion()->tables->get_element_at( $slug )->get_single_item_name();
            ?>
        </span>
