...
<div class="plugion_input_container_small">
    ...
    <label for="<?php echo esc_attr( $slug ) . '_date_range_start' ?>" class="plugion_input_text_label"><?php echo esc_html( plugion_translate_string( 'Start' ) ) ?></label>
</div>
<div class="plugion_input_container_small">
    <input id="<?php echo esc_attr( $slug ) . '_date_range_end'  ?>" class="plugion_input_date_range_end plugion_input_text" required>
    <label for="<?php echo esc_attr( $slug ) . '_date_range_end' ?>" class="plugion_input_text_label"><?php echo esc_html( plugion_translate_string( 'End' ) ) ?></label>
</div>
