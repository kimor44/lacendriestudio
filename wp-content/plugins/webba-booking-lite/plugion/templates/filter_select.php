...
<li class="cell-3">
    <div class="custom-select-wb">
        <select name="<?php echo esc_attr( $slug ); ?>" class="bookings-filter-select plugion_filter_input">
            <option value="">All <?php echo esc_html( $titles[ strtolower( $field->get_title() ) ] ) ?></option>
