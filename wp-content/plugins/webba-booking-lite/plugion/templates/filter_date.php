...
<div class="plugion_input_container">
    <input  id="<?php echo esc_attr( $slug ) ?>"  name="<?php echo esc_attr( $field->get_name() ); ?>"  class="plugion_input plugion_input_text plugion_filter_input" data-validation="date" type="text"  data-dateformat="<?php echo esc_attr( $date_fomrat ) ?>"  data-setter="date" data-getter="date" required>
