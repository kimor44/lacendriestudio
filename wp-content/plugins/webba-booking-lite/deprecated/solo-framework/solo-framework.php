...
function slfLoadAssets(){
	if ( isset( $_GET[ 'page' ] ) && ( $_GET[ 'page' ] == 'wbk-appearance'   ||
	    ...
	    wp_enqueue_style( 'slf-default-style', plugins_url( '/css/slf-default.css', __FILE__ ), array(), '4.0.73' );
...
class SoloFramework extends stdClass  {
	...
	public function renderPreview( $slug ){
 		$html =  '<div class="wbk-outer-container wbk_booking_form_container">
	...
	public function renderSectionSetControls( $slug ){
		...
		$presets_folder =  WP_WEBBA_BOOKING__PLUGIN_DIR . DIRECTORY_SEPARATOR . 'deprecated' . DIRECTORY_SEPARATOR . 'presets' . DIRECTORY_SEPARATOR.'*';
