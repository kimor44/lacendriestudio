...
function getAllowedClassNames() {
	return array( 'WBK_Appointment_deprecateds_Table' , 'WBK_Email_Templates_Table', 'WBK_Service_Categories_Table', 'WBK_Service_Categories_Table', 'WBK_GG_Calendar_Table', 'WBK_Coupons_Table', 'WBK_Cancelled_Appointments_Table' );
}
	...
	if ( !in_array( $class_name, getAllowedClassNames() ) ){
 	...
 	$result = array();
  	...
  	if( count( $error_fields ) == 0  ){
  		...
  		$condition_data[0] = array( 'id' => $row_id );
