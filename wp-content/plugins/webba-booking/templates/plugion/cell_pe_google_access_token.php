...
if ( wbk_fs()->is__premium_only() ) {
    if ( wbk_fs()->can_use_premium_code() ) {
        ...
        if( $connection_status[0] == 1 ){
            $html .=  '<span class="wbk_google_auth_success"><img src="'. WP_WEBBA_BOOKING__PLUGIN_URL . '/backend/images/success.png"
        ...
        if( $connection_status[0] == 0 ){
            $html .= '<span class="wbk_google_auth_warning"><img src="'. WP_WEBBA_BOOKING__PLUGIN_URL . '/backend/images/warning.png"
                ...
                $control_html;
            $html .= $connection_status[1];
        }
        if( $connection_status[0] == 2 ){
            $html .= '<span class="wbk_google_auth_error"><img src="'. WP_WEBBA_BOOKING__PLUGIN_URL . '/backend/images/error.png"
                        alt="error">' . __( 'Authorization failed', 'wbk' ) . '</span>' .
