...
class WBK_Model_Updater {
    ...
    static function update_3_0_3(){
        ...
        $wpdb->query(
            "CREATE TABLE IF NOT EXISTS " . get_option( 'wbk_db_prefix', '' ) . "wbk_email_templates (
    ...
    static function update_3_1_0(){
        ...
        $wpdb->query(
                "CREATE TABLE IF NOT EXISTS " . get_option('wbk_db_prefix', '' ) . "wbk_service_categories(
                id int unsigned NOT NULL auto_increment PRIMARY KEY,
                name varchar(128) default '',
    ...
    static function update_3_2_0(){
        ...
        // google calendar
        $wpdb->query(
            "CREATE TABLE IF NOT EXISTS " . get_option( 'wbk_db_prefix', '' ) . "wbk_gg_calendars (
                id int unsigned NOT NULL auto_increment PRIMARY KEY,
                name varchar(128) default '',
    ...
    static function update_3_3_7(){
        ...
        $wpdb->query(
            "CREATE TABLE IF NOT EXISTS " . get_option( 'wbk_db_prefix', '' ) . "wbk_coupons (
                id int unsigned NOT NULL auto_increment PRIMARY KEY,
                name varchar(128) default '',
    ...
    static function update_3_3_61(){
        ...
        $wpdb->query(
                "CREATE TABLE IF NOT EXISTS " . get_option( 'wbk_db_prefix', '' ) . "wbk_cancelled_appointments (
                    id int unsigned NOT NULL auto_increment PRIMARY KEY,
            ...
            foreach( $coupons as $key => $value ){
                ...
                if( $coupon->get('services') != '' ){
                    if( is_null( json_decode( $coupon->get('services') ) ) ){
                        ...
                        $wpdb->update(  get_option( 'wbk_db_prefix', '' ) . 'wbk_coupons',
        ...
        if( self::is_update_required('4.0.0.service_categories' ) ){
            ...
            foreach( $category_ids as $category_id ){
                ...
                if( is_null( json_decode( $service_category->get('category_list') ) ) ){
                    ...
                    $wpdb->update(  get_option('wbk_db_prefix', '' ) . 'wbk_service_categories',
    ...
    static function update_4_1_3(){
        ...
        if ( wbk_fs()->is__premium_only() ) {
            if ( wbk_fs()->can_use_premium_code() ) {
                if( self::is_update_required('update_4_1_3' ) ){
                    $wpdb->query("ALTER TABLE " . get_option( 'wbk_db_prefix', '' ) . "wbk_services CHANGE `extcalendar` `extcalendar` MEDIUMTEXT NOT NULL");
                    self::set_update_as_complete('update_4_1_3');
                }
            }
        }
    }
